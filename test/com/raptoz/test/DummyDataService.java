...
//		List<Post> tozList = tozMapper.findAll();
//		
//		for (int i = 0; i < 200; i++) {
//			Post randomToz = tozList.get(random.nextInt(tozList.size()));
...
//				tozParticipantMapper.save(new Reply(randomTozId, randomUserId, "my toz..." + i));
//			else
//				tozParticipantMapper.save(new Reply(randomTozId, randomUserId, generateDummyComment() + i));
//		}
//	}
//	
...
//	}
//
//	private boolean isOwner(Post randomToz, Long randomUserId) {
//		return randomToz.getQuestionerId() == randomUserId;
//	}
//
//	private void createDummyTozWithTags(User user) {
//		Post toz = new Post("some title", user.getId(), dummyText.substring(0, 100 + random.nextInt(700)));
//		tozMapper.save(toz);
//		
